...
public class ComposeFragment extends Fragment {
    ...
    // onCreateView is called when Fragment should create its View object hierarchy, either dynamically or via XML layout inflation
    @Override
    ...
    // view setup should occur here e.g. attaching listeners etc
    @Override
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(photoFile == null || imageView.getDrawable() == null){
                    Toast.makeText(getContext(), "No image included!", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void savePost(String description, ParseUser currentUser, File photoFile) {
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                ...
                Toast.makeText(getContext(), "Posted successfully", Toast.LENGTH_SHORT);
                Intent i = new Intent();
               etDesc.setText("");
